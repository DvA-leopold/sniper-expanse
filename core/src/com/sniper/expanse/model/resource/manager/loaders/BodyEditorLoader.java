...
public class BodyEditorLoader {
    ...
    public BodyEditorLoader(String fileName) {
        FileHandle handle = new InternalFileHandleResolver().resolve(fileName);
        if (handle == null) throw new NullPointerException("file is null");
        model = readJson(handle.readString());
    }
